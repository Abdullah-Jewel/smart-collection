...
export default function PhoneEmulator({
  ...
  const [ownerInfo, setOwnerInfo] = useState({
    ...
    boutiquePhotoUrl: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=600&auto=format&fit=crop',
              ...
              {isOwnerEditing ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="w-full animate-fade-in relative group">
                    <div className="w-full h-44 rounded-b-xl overflow-hidden shadow-xs border border-neutral-200 bg-neutral-100 flex items-center justify-center">
                      <img 
